...
def run_test_count_items_bigger_than():
    ...
    # Test 10:
    sequence = [-10.03, 7, 89, 912, 1024, 73]
    threshold = 10
    expected = 4
    actual = count_items_bigger_than(sequence, threshold)
    print()
...
def run_test_count_positive_sines():
    ...
    # Test 11:
    expected = 2
    actual = count_positive_sines([12, 14, 26])
    print()
...
def run_test_sum_first_n():
    ...
    # Test 8:
    expected = 0
    actual = sum_first_n([4, 8, -12, -23, 5], 3)
    print()
    print('Test 8 expected:', expected)
    print('       actual:  ', actual)
    ...
    # Test 9:
    expected = 30
    actual = sum_first_n([-13, -25, 73, -5, -83], 4)
    print()
    print('Test 9 expected:', expected)
    print('       actual:  ', actual)
